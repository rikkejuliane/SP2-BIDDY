...
export function openEditProfileModal(profileData) {
  ...
  modalContent.className =
    "relative bg-white p-6 rounded-lg shadow-lg z-[10000] w-[350px] flex flex-col justify-center items-center max-h-[70vh] overflow-auto";
  ...
  avatarInput.className =
    "mt-1 p-2 shadow-md rounded w-[302px] h-[35px] bg-lavender-blue bg-opacity-20 placeholder-charcoal-grey placeholder:font-inter placeholder:text-sm";
  ...
  bioInput.className =
    "mt-1 p-2 shadow-md rounded w-[302px] h-[80px] bg-lavender-blue bg-opacity-20 placeholder-charcoal-grey placeholder:font-inter placeholder:text-sm";

  const saveButton = document.createElement("button");
  saveButton.type = "submit";
  saveButton.className =
    "mt-5 bg-royal-blue text-white text-lg font-serif font-bold p-2 rounded w-[150px] h-[35px] flex items-center justify-center";
